...
export const AutoThemeIcon: React.FC<Partial<CustomIconComponentProps>> = (props) => (
  <Icon component={AutoThemeSvg} {...props} />
)

export const LightIcon: React.FC<Partial<CustomIconComponentProps>> = (props) => (
  <Icon component={LightSvg} {...props} />
)

export const DarkIcon: React.FC<Partial<CustomIconComponentProps>> = (props) => <Icon component={DarkSvg} {...props} />
